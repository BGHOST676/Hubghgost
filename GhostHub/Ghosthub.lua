...
--------------------------
local Main = ("Menu 💀","rbxassetid://11446825283")
local Setting = ("Configurações⚙️","rbxassetid://11446835336")
local Weapon ("Espadas⚔️ | Missões📜","rbxassetid://11446859498")
local Race = ("Raça V4🌠","rbxassetid://11446900930")
local Stats = ("Status📃","rbxassetid://11447069304")
local P = ("Player🙎","rbxassetid://11446900930")
local Teleport = ("Teleporte🌠","rbxassetid://11446920523")
local Dungeon = ("Raid⚡","rbxassetid://11446957539")
local DevilFruit = ("Sniper🍎","rbxassetid://11446965348")
local Shop = ("Loja🛒","rbxassetid://6031265976")
local Misc = ("Outros🏁","rbxassetid://11447063791")
...
Setting:Seperator(" Configurações Da Maestria ")
...
Time:Set("[Horas Jogadas] : Hours : "..Hour.." Minutes : "..Minute.." Seconds : "..Second)
end
...
Stats:Slider("Selecionar Pontos",1,100,1,function(value)
_G.Point = value
...
P:Seperator(" Matar Player(Ghost não recomenda) ")
...
Dungeon:Seperator("Use somente na Raid")
